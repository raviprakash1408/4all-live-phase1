...
import EditorRole1 from '@/components/EditorRole';
  ...
  return (
    <div className="flex h-[92vh] w-[100%] justify-between bg-primary-color p-2">
      <div className="w-[10%] overflow-hidden rounded-l-3xl">
        ...
        >
          <Image
            src="/assets/icons/active-roles.svg"
            alt="roles"
            width={25}
            height={25}
          />
      ...
      {isRoles && <Roles isRoles={isRoles} setIsRoles={setIsRoles} />}
      {!isRoles && <EditorRole1 />}
    </div>
  );
};
